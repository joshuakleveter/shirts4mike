...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (!isset($error_message)) {
    ...
    $mail->addAddress('joshua.kleveter@gmail.com', 'Shirts 4 Mike');
    //Set the subject line
    $mail->Subject = 'Shirts 4 Mike Contact Form | ' . $name;
  ...
  <div class="section page">
    ...
    <div class="wrapper">
      ...
      <?php } else { ?>
        ...
        <?php
          if (!isset($error_message)) {
            echo "<p>I&rsquo;d love to hear from you! Complete the form below to send me an email.</p>";
          } else {
